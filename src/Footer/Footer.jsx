  ...
  return (
    ...
    <footer className="footer a2-bg position-relative pt-15 pt-lg-0 z-0 ">
      ...
      <div className="container">
        <div className="start-earning nb3-bg cus-rounded-2 d-flex align-items-center p-4 p-sm-6 p-md-10 p-lg-15 foot-p-xl-20 pe-lg-6 pe-xl-16 overflow-hidden position-relative">
          ...
          <div className="row gy-6 w-100 text-center text-sm-start align-items-center justify-content-sm-between">
            ...
            <div className="col-sm-4 text-sm-end">
              ...
              >
                Register <i className="ti ti-arrow-right fs-four" />
              </a>
            </div>
          </div>
        </div>
        <div className="row gy-8 gy-sm-12 gy-lg-0 pt-120 pb-120">
          <div className="col-6 col-lg-3">
            <div className="footer__part">
              ...
              <ul className="footer_list d-flex flex-column gap-2 gap-sm-3 gap-md-4">
                ...
                <li>
                  <a className="n2-color" href="education.html">
                    Education
                  </a>
                </li>
                <li>
                  <a className="n2-color" href="support.html">
                    Support
                  </a>
                </li>
                <li>
                  <a className="n2-color" href="legal-docs.html">
                    Legal docs
                  </a>
                </li>
              </ul>
          ...
          <div className="col-6 col-lg-3">
            <div className="footer__part">
              ...
              <ul className="footer_list d-flex flex-column gap-2 gap-sm-3 gap-md-4">
                <li>
                  <a className="n2-color" href="about.html">
                    About
                  </a>
                </li>
                <li>
                  <a className="n2-color" href="blog.html">
                    Blog
                  </a>
                </li>
                <li>
                  <a className="n2-color" href="careers.html">
                    Carreers
                  </a>
                </li>
              </ul>
          ...
          <div className="col-6 col-lg-3">
            <div className="footer__part">
              <h4 className="mb-6 mb-lg-8 foot-m50">Legal</h4>
              <ul className="footer_list d-flex flex-column gap-2 gap-sm-3 gap-md-4">
                <li>
                  <a className="n2-color" href="terms-conditions.html">
                    Terms &amp; Conditions
                  </a>
                </li>
                <li>
                  <a className="n2-color" href="privacy-policy.html">
                    Privacy &amp; Policy
                  </a>
                </li>
                <li>
          ...
          <div className="col-6 col-lg-3">
            <div className="footer__part">
              ...
              <div className="d-flex flex-column gap-2 gap-sm-3 gap-md-4">
                <a href="/cdn-cgi/l/email-protection#f79e999198b7928f969a879b92d994989a">
                  <span
                    className="__cf_email__"
                    data-cfemail="573e39313817322f363a273b327934383a"
                  >
                    [email&nbsp;protected]
                  </span>
                </a>
          ...
          <div className="col-12 border-top border-color opac-20 py-7 py-xxl-8">
            <div className="footer__copyright d-center gap-15 flex-wrap justify-content-md-between">
              <p className="fs-six order-2 order-md-0 text-center text-md-start">
                Copyright ©<span className="currentYear" /> Tradez 2024
              </p>
